...
async function main() {
    ...
    const mantCategories = [
        ...
        { name: 'Suspensión', description: 'Sistema de suspensión y amortiguadores' },
    ...
    const mantItemsData = [
        ...
        { name: 'Cambio de Bujías', description: 'Reemplazo de bujías de encendido', mantType: 'PREVENTIVE', estimatedTime: 2.0, category: 'Motor' },
        { name: 'Ajuste de Motor', description: 'Ajuste general del motor', mantType: 'PREVENTIVE', estimatedTime: 3.0, category: 'Motor' },
        { name: 'Reparación de Motor', description: 'Reparación mayor de motor', mantType: 'CORRECTIVE', estimatedTime: 16.0, category: 'Motor' },
        ...
        { name: 'Purgado de Frenos', description: 'Cambio de líquido de frenos', mantType: 'PREVENTIVE', estimatedTime: 1.0, category: 'Frenos' },
        { name: 'Ajuste de Frenos', description: 'Calibración del sistema de frenos', mantType: 'PREDICTIVE', estimatedTime: 1.5, category: 'Frenos' },
        
        // Suspensión
        { name: 'Cambio de Amortiguadores', description: 'Reemplazo de amortiguadores delanteros', mantType: 'PREVENTIVE', estimatedTime: 4.0, category: 'Suspensión' },
        { name: 'Cambio de Resortes', description: 'Reemplazo de resortes de suspensión', mantType: 'CORRECTIVE', estimatedTime: 5.0, category: 'Suspensión' },
        { name: 'Alineación y Balanceo', description: 'Alineación de dirección y balanceo', mantType: 'PREVENTIVE', estimatedTime: 2.0, category: 'Suspensión' },
        
        // Transmisión
        { name: 'Cambio de Aceite Transmisión', description: 'Cambio de aceite de caja de cambios', mantType: 'PREVENTIVE', estimatedTime: 2.0, category: 'Transmisión' },
        { name: 'Ajuste de Embrague', description: 'Calibración del embrague', mantType: 'PREDICTIVE', estimatedTime: 1.5, category: 'Transmisión' },
        { name: 'Cambio de Embrague', description: 'Reemplazo completo del embrague', mantType: 'CORRECTIVE', estimatedTime: 8.0, category: 'Transmisión' },
        
        // Eléctrico
        { name: 'Revisión Sistema Eléctrico', description: 'Diagnóstico completo del sistema eléctrico', mantType: 'PREDICTIVE', estimatedTime: 2.5, category: 'Eléctrico' },
        { name: 'Cambio de Batería', description: 'Reemplazo de batería', mantType: 'CORRECTIVE', estimatedTime: 1.0, category: 'Eléctrico' },
        { name: 'Cambio de Alternador', description: 'Reemplazo del alternador', mantType: 'CORRECTIVE', estimatedTime: 4.0, category: 'Eléctrico' },
        
        // Neumáticos
        { name: 'Rotación de Neumáticos', description: 'Rotación de neumáticos por desgaste', mantType: 'PREVENTIVE', estimatedTime: 1.0, category: 'Neumáticos' },
        { name: 'Cambio de Neumáticos', description: 'Reemplazo de neumáticos', mantType: 'PREVENTIVE', estimatedTime: 2.0, category: 'Neumáticos' },
        { name: 'Reparación de Pinchadura', description: 'Reparación de neumático pinchado', mantType: 'EMERGENCY', estimatedTime: 0.5, category: 'Neumáticos' },
        ...
        // Fluidos
        { name: 'Cambio Líquido Refrigerante', description: 'Cambio del sistema de refrigeración', mantType: 'PREVENTIVE', estimatedTime: 1.5, category: 'Fluidos' },
        { name: 'Cambio Líquido Dirección', description: 'Cambio de líquido de dirección asistida', mantType: 'PREVENTIVE', estimatedTime: 1.0, category: 'Fluidos' },
        { name: 'Cambio Líquido Limpiaparabrisas', description: 'Recarga de líquido limpiaparabrisas', mantType: 'PREVENTIVE', estimatedTime: 0.25, category: 'Fluidos' },
        
        // Correas
        { name: 'Cambio Correa Distribución', description: 'Reemplazo de correa de distribución', mantType: 'PREVENTIVE', estimatedTime: 6.0, category: 'Correas' },
        ...
        // Carrocería
        { name: 'Lavado y Encerado', description: 'Lavado completo y encerado del vehículo', mantType: 'PREVENTIVE', estimatedTime: 3.0, category: 'Carrocería' },
        { name: 'Reparación de Rayones', description: 'Reparación de rayones menores', mantType: 'CORRECTIVE', estimatedTime: 2.0, category: 'Carrocería' },
        { name: 'Pintura Completa', description: 'Pintura completa del vehículo', mantType: 'CORRECTIVE', estimatedTime: 24.0, category: 'Carrocería' }
    ]
    ...
    const technicians = [
        { name: 'Carlos Rodríguez', email: 'carlos@email.com', phone: '3001234567', specialty: 'Motor y Transmisión' },
        { name: 'María González', email: 'maria@email.com', phone: '3007654321', specialty: 'Sistema Eléctrico' },
        { name: 'Luis Martínez', email: 'luis@email.com', phone: '3009876543', specialty: 'Frenos y Suspensión' },
        { name: 'Ana López', email: 'ana@email.com', phone: '3005432109', specialty: 'Carrocería y Pintura' },
        { name: 'José Pérez', email: 'jose@email.com', phone: '3002468135', specialty: 'Mantenimiento General' }
    ]
    ...
    const providers = [
        ...
        { name: 'Electro Auto', email: 'electro@auto.com', phone: '6015559876', address: 'Avenida 68 #45-12', specialty: 'Sistema Eléctrico' },
        { name: 'Pintura Express', email: 'pintura@express.com', phone: '6015554321', address: 'Calle 85 #23-45', specialty: 'Pintura y Carrocería' },
        { name: 'Motor Tech', email: 'motor@tech.com', phone: '6015558765', address: 'Carrera 15 #78-90', specialty: 'Motor y Transmisión' }
    ]
    ...
    const vehiclesData = [
        ...
        { licensePlate: 'VWX-234', brand: 'Audi', line: 'Quattro', type: 'Automóvil', year: 2023, color: 'Negro', mileage: 12000, photo: '/images/audi_quattro.jpeg' },
        { licensePlate: 'YZA-567', brand: 'Volvo', line: 'C40', type: 'Automóvil', year: 2024, color: 'Blanco', mileage: 3000, photo: '/images/volvo_c40_white.jpg' },
        ...
        { licensePlate: 'NOP-012', brand: 'Mazda', line: 'CX-5', type: 'Camioneta', year: 2023, color: 'Gris Metálico', mileage: 7000, photo: '/images/hilux.jpg' },
        ...
        { licensePlate: 'QRS-345', brand: 'Toyota', line: 'Corolla', type: 'Automóvil', year: 2023, color: 'Plata', mileage: 4000, photo: '/images/hilux.jpg' },
        { licensePlate: 'TUV-678', brand: 'Chevrolet', line: 'Cruze', type: 'Automóvil', year: 2022, color: 'Negro', mileage: 16000, photo: '/images/chevrolet_cyz.jpg' },
        { licensePlate: 'WXY-901', brand: 'Ford', line: 'Focus', type: 'Automóvil', year: 2021, color: 'Azul', mileage: 29000, photo: '/images/ford_ranger.jpg' },
        { licensePlate: 'ZAB-234', brand: 'Nissan', line: 'Sentra', type: 'Automóvil', year: 2023, color: 'Blanco', mileage: 6500, photo: '/images/nissan_frontier_pagina_web.jpg' },
        { licensePlate: 'CDE-567', brand: 'Mazda', line: 'Mazda3', type: 'Automóvil', year: 2022, color: 'Gris', mileage: 21000, photo: '/images/hilux.jpg' },
        { licensePlate: 'FGH-890', brand: 'Toyota', line: 'Camry', type: 'Automóvil', year: 2021, color: 'Negro', mileage: 38000, photo: '/images/hilux.jpg' },
        { licensePlate: 'IJK-123', brand: 'Chevrolet', line: 'Spark', type: 'Automóvil', year: 2023, color: 'Rojo', mileage: 2000, photo: '/images/chevrolet_cyz.jpg' },
    ]
            ...
            for (const planTask of compatiblePlan.planTasks) {
                ...
                for (let cycle = cycles; cycle <= cycles + 3; cycle++) {
                    ...
                    if (executionMileage <= currentKm) {
                        ...
                        if (randomStatus < 0.7) {
                            status = 'COMPLETED'
                            startDate = new Date(Date.now() - Math.random() * 30 * 24 * 60 * 60 * 1000) // Hasta 30 días atrás
                            endDate = new Date(startDate.getTime() + Math.random() * 8 * 60 * 60 * 1000) // Hasta 8 horas después
                            cost = Math.random() * 500000 + 50000 // Entre 50,000 y 550,000 COP
                        } else if (randomStatus < 0.9) {
                            status = 'IN_PROGRESS'
                            startDate = new Date(Date.now() - Math.random() * 7 * 24 * 60 * 60 * 1000) // Hasta 7 días atrás
                        }
    ...
    console.log('✅ Planes asignados a vehículos e items de mantenimiento creados')
