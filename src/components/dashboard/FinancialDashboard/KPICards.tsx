    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">por vehículo activo</p>
        </CardContent>
      </Card>
      ...
      >
        ...
        <CardContent>
          ...
          {kpis.pendingInvoicesCount > 0 && (
            <p className="text-xs text-yellow-700">Requiere atención</p>
          )}
        </CardContent>
      </Card>
      ...
      >
        ...
        <CardContent>
          ...
          >
            ...
            {kpis.trendPercentage === 0
              ? '0%'
              : `${kpis.trendPercentage > 0 ? '+' : ''}${kpis.trendPercentage}%`}
          </div>
          <p className="text-xs text-muted-foreground mt-1">
