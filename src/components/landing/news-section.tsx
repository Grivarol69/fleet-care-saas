  ...
  const articles = [
    {
      ...
      excerpt:
        'Descubre cómo la inteligencia artificial está transformando la industria del transporte.',
      date: '15 Mar 2024',
    ...
    },
    {
      ...
      excerpt:
        'Todo lo que necesitas saber sobre las nuevas normativas ambientales para flotas.',
      date: '12 Mar 2024',
    ...
    },
    {
      ...
      excerpt:
        'Casos reales de empresas que han optimizado sus operaciones con Fleet Care.',
      date: '8 Mar 2024',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
            Mantente al día con las últimas novedades y tendencias en gestión de
            flotas.
          </p>
        </div>
