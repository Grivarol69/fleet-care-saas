...
export const dataAdminSidebar: SidebarItem[] = [
    ...
    },
    {
        ...
        subItems: [
            { label: "Información", href: "/dashboard/empresa/informacion", roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER] },
            {
                label: "Configuración",
                icon: Settings,
            ...
            { label: "Sucursales", href: "/dashboard/empresa/sucursales", roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER] },
        ],
    },
    {
        icon: Truck,
    ...
    },
    {
        ...
        subItems: [
            { label: "Crear", href: "/dashboard/checklist/crear", roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER] },
            { label: "Inspeccionar", href: "/dashboard/checklist/inspeccionar", roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER, UserRole.TECHNICIAN] },
            { label: "Historial", href: "/dashboard/checklist/historial", roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER, UserRole.TECHNICIAN] },
        ],
    },
    {
        icon: Users,
    ...
    },
    {
        ...
        roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER],
        subItems: [
            { label: "Costos", href: "/dashboard/reports/maintenance-costs", roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER] }, // TECHNICIAN no ve costos
            { label: "Estado Flota", href: "/dashboard/reports/fleet-status", roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER] },
            { label: "Eficiencia", href: "/dashboard/reports/maintenance-efficiency", roles: [UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.MANAGER] },
        ],
    },
    {
        icon: Settings,
