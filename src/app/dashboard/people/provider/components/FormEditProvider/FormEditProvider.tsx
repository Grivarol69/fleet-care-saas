  ...
  useEffect(() => {
    if (defaultValues) {
      form.reset({
        ...
        siigoIdType: (defaultValues.siigoIdType as any) || '',
        siigoPersonType: (defaultValues.siigoPersonType as any) || '',
        stateCode: defaultValues.stateCode || '',
        cityCode: defaultValues.cityCode || '',
        fiscalResponsibilities: defaultValues.fiscalResponsibilities || [],
        vatResponsible: defaultValues.vatResponsible || false,
      });
    }
  }, [defaultValues, form]);
