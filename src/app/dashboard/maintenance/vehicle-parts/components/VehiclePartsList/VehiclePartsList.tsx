...
export function VehiclePartsList() {
    ...
    const [editingEntry, setEditingEntry] = useState<VehiclePartEntry | null>(null);
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            if (filterMantItemId !== 'all') params.set('mantItemId', filterMantItemId);
        ...
        <div>
            ...
            <div className="flex flex-wrap items-end gap-4 mb-4">
                ...
                <div className="space-y-1">
                    ...
                    <Select
                        value={filterMantItemId}
                        onValueChange={setFilterMantItemId}
                    >
