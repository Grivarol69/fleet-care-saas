  ...
  if (!driver) {
    return (
      <div className="min-h-screen bg-[#F1F5F9] flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-gray-600">Tu usuario no tiene un perfil de Conductor asignado. Por favor, contacta a tu administrador.</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9] pb-24">
      <div className="bg-[#1E3A5F] text-white p-6 pt-12 pb-8 rounded-b-3xl shadow-lg">
        ...
        <p className="text-blue-100 mt-1 text-sm">Selecciona el vehículo que conducirás</p>
      </div>
