...
import { z } from 'zod';
import { decryptAccessKey, encryptAccessKey, validateSiigoEncryptionKey } from '@/lib/services/siigo';
...
export async function POST(req: Request) {
    try {
        ...
        const newSiigoConfig = {
            ...
            defaultCostCenterId: body.defaultCostCenterId ?? existingSiigo.defaultCostCenterId ?? 0,
            defaultPaymentTypeId: body.defaultPaymentTypeId ?? existingSiigo.defaultPaymentTypeId ?? 0,
            defaultDocumentTypeId: body.defaultDocumentTypeId ?? existingSiigo.defaultDocumentTypeId ?? 0,
        };
