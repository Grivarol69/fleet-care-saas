...
export default async function TemplatesPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900">Templates Globales</h1>
        <p className="text-slate-600">Plantillas de mantenimiento disponibles para todos los tenants</p>
      </div>
