  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Adjunto encontrarás la hoja de vida del vehículo con placa <strong>{vehiclePlate}</strong>,
          junto con todos sus documentos legales vigentes.
        </Text>
        ...
        <ul style={list}>
          <li><strong>CV del vehículo</strong> con datos técnicos completos</li>
          <li><strong>Documentos legales</strong> (SOAT, Tecnomecánica, Póliza, etc.) si están disponibles</li>
        </ul>

        <Section style={buttonContainer}>
          <Text style={text}>
            Si tienes alguna pregunta sobre este documento, no dudes en contactarnos.
          </Text>
        </Section>
